...
<html lang="en">
 ...
 <div class="col-xs-12">
	<div class="panel panel-default panel-border-color panel-border-color-primary">
        <div class="panel-heading panel-heading-devider">Detail Barang</div>
        <div class="panel-body">
        	<form method="post" class="form-horizontal group-border-dashed" autocomplete="off" action="coba.php">
        				...
        				<table class="table table-condensed table-hover table-bordered table-striped">
        					...
        					<tbody>
        						<?php
        							$No=1;
                                    $pegawai = $_SESSION['id'];
        							$check = mysqli_query($koneksi,"Select p.id_peminjaman,d.id_detailpinjam,i.kode_inventaris,i.nama FROM peminjaman p JOIN detailpinjam d ON p.id_peminjaman=d.id_peminjaman JOIN inventaris i ON d.id_inventaris=i.id_inventaris WHERE p.id_peminjaman = '$id'");
